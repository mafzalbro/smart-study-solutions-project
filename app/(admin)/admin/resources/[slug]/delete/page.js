    ...
    <>
      ...
      <div className="my-10 px-4">
        ...
        <form onSubmit={handleSubmit} className="flex gap-4">
          ...
          <Link href="/admin/resources" className={`inline-flex cursor-pointer items-center space-x-2 py-2 px-4  text-accent-900 bg-accent-100 hover:bg-accent-200 dark:bg-accent-300 dark:hover:bg-accent-400 rounded-lg text-center`}>Cancel</Link>
        </form>
      </div>
    </>
  );
