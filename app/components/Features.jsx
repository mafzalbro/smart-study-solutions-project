...
const Features = () => {
  return (
    <div className="my-16 p-16 md:p-5">
      <div className="flex flex-col md:flex-row justify-around gap-10">
        <div className="text-center">
          <FaRobot className="text-accent-600 text-5xl mx-auto mb-4" />
        ...
        <div className="text-center">
          <FaQuestionCircle className="text-accent-600 text-5xl mx-auto mb-4" />
        ...
        <div className="text-center">
          <FaBell className="text-accent-600 text-5xl mx-auto mb-4" />
        ...
        <div className="text-center">
          <FaBook className="text-accent-600 text-5xl mx-auto mb-4" />
