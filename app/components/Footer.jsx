...
const Footer = () => {
  ...
  const restrictedPaths = ["/chat", "/admin"];
    ...
    <footer className="bg-neutral-800 text-neutral-100 p-6 text-center">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-6">
          <div>
            ...
            <p className="mb-4 text-neutral-400">
              Your go-to platform for academic resources and support.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-neutral-400">
              ...
              <li>
                <Link href="/resources" className="hover:text-neutral-200">
                  Study Material
                </Link>
              </li>
              <li>
                <Link href="/forum" className="hover:text-neutral-200">
                  QnA Forum
                </Link>
              </li>
              {isLoggedIn && (
                <li>
                  <Link href="/chat" className="hover:text-neutral-200">
                    AI Chat
                  </Link>
                </li>
              )}
        ...
        <div className="mt-8 text-center text-neutral-400">
          <p>
            &copy; {new Date().getFullYear()} Smart Study Solutions. All rights
            reserved.
          </p>
        </div>
      </div>
