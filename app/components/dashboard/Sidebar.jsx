...
export default function Sidebar({ height }) {
  ...
  return (
    <div
      ref={scrollRef}
      className={`md:flex-col md:sticky md:z-40 md:top-0 md:h-screen md:gap-4 flex flex-row gap-2 shadow-lg md:p-4 md:w-1/3 lg:w-1/4 overflow-x-auto overflow-y-hidden whitespace-nowrap scrollbar-hide rounded-lg bg-neutral-200 dark:bg-neutral-800 md:bg-transparent md:dark:bg-transparent my-8 w-[90vw] mx-auto md:mx-0 md:my-0 pl-2 py-2`}
